...
//
//        BudgetEntity budgetEntity = maximumBudgetRepo.findByUserIdAndCategory(expenseRequest.getUser().getUserId(),expenseRequest.getCategory());
//        if(budgetEntity == null){
//            BudgetEntity maximumBudget = new BudgetEntity();
...
//        }
//        else{
//            budgetEntity.setMaxAllowedAmount(expenseRequest.getMaxAllowedAmount());
//            maximumBudgetRepo.save(budgetEntity);
//        }
